...
import com.example.restaurant.DAO.OrderDitailDAO;
...
public class PutAmountActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private OrderDitailDAO orderDitailDAO;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        orderDitailDAO = new OrderDitailDAO(this);
...
//                Toast.makeText(this, "KhongTonTai" , Toast.LENGTH_SHORT).show();
                ...
                boolean checkAdd = orderDitailDAO.addOrderDetail(new OrderDetailDTO(orderId, dishId, amount));
                if (checkAdd){
                    Toast.makeText(this, R.string.success, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, R.string.failed, Toast.LENGTH_SHORT).show();
